...
<body>
    ...
    'Approved': 'badge2',
    'Rejected': 'badge3',
    'approved by the line manager': 'badge4',
    'Approved by the Administrative Associate': 'badge4'
    } %}
    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <p style="color: #555; font-size: 15px;">
                نود اعلامكم انه تم تحديث حالة طلب الاجازة المقدم من قبلكم و كما مبين ادناه.
            </p>
            ...
            <table class="info-table">
                ...
                <tr>
                    <td>حالة الطلب</td>
                    <td>
                        <span class=" {{ status_map2.get(doc.workflow_state, badge1) }} ">{{ status_map.get(doc.workflow_state, doc.workflow_state) }}</span>
                    </td>
                </tr>
            </table>
            ...
            <!-- Notice -->
            <div class="notice">
                 في حال وجود أي استفسار يرجى التواصل مع شعبة الموارد البشرية.
            </div>
