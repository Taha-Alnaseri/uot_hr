    ...
    <div class="container">
        ...
        <div class="body">
            ...
            <p style="color: #555; font-size: 15px;">
                لقد تم تقديم طلب اجازة من احد منتسبي القسم او الشعبة المسؤول عنها يرجى اتخاذ اجراء و بحسب تفاصيل الاجازة ادناه .
            </p>
            ...
            <!-- Notice -->
            <div class="notice">
                بعد الضغط على زر عرض طلب الاجازة بالاسفل سيتم نقلك الى نظام الاجازات لغرض اتخاذ اجراء و سوف يتم طلب تسجيل الدخول في حال لم تسجل الدخول الى حسابك مسبقا.
            </div>

        </div>
        {% set base_url = frappe.utils.get_url() %}
        {% set request_url = base_url ~ '/app/uot-leave-request/' ~ doc.name %}
